...
// Function to determine encryption algorithm based on key length
...
// Function to generate a Zego token
function generateToken04(appId, userId, secret, effectiveTimeInSeconds, payload) {
    ...
    if (!effectiveTimeInSeconds || typeof effectiveTimeInSeconds !== 'number') throw { errorCode: ErrorCode.effectiveTimeInSecondsInvalid, errorMessage: 'effectiveTimeInSeconds invalid' };
